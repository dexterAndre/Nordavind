...
public class AudioAvatar : SFXController {
    ...
    private void Start()
    {
        ...
        if (transform.parent.GetChild(1).transform.GetChild(0).transform.GetChild(0).GetComponent<AudioSource>() != null)
            mThirdAudioSource = transform.parent.GetChild(1).transform.GetChild(0).transform.GetChild(0).GetComponent<AudioSource>();
